document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            question: "¿A quién se refiere el narrador como el mejor jugador de su equipo?", 
            answers: [
                "Toddy", 
                "El Peto", 
                "Walter", 
        ...
        {
            question: "¿Qué juego practicaban?", 
            answers: [
                "Golf", 
                "Baloncesto", 
                "Fútbol", 
        ...
        {
            question: "¿En qué lugar disfrutaban jugar futbol?", 
            answers: [
            ...
            correctAnswer: "En el potrero"
        },
        {
            question: "¿En qué lugar se encontraron con la banda de Peto?", 
            answers: [
                "En la cancha de golf", 
                "En la plaza principal", 
                "En la cuadra cerca a la casa de Walter", 
                "En el potrero al lado de la cancha de estudiantes de Buenos Aires"
            ], 
            correctAnswer: "En el potrero al lado de la cancha de estudiantes de Buenos Aires"
        },
        {
            question: "¿Qué recuerdos tiene el narrador del juego de fútbol?", 
            answers: [
                "La carrera que pegó para evitar la paliza de Peto", 
                "La pelota, la calle y los amigos de infancia", 
                "Ver televisión con su amigo Walter", 
                "La cancha de golf, donde jugaba los partidos"
            ], 
            correctAnswer: "La pelota, la calle y los amigos de infancia"
        }
    ];
